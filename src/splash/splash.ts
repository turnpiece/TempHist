...
// Re-exported for existing importers (main.ts, views/today/index.ts) — the
// implementation lives in ../topnav so lean entry points (the share page) can
// use it without pulling in this whole module.
export { setupMobileNavigation, handleWindowResize };
